...
Description = 'DSC Resource for a vSphere environment'
...
DscResourcesToExport = 'VmwFolder', 'VmwDatacenter', 'VmwVMHost', 'VmwCluster', 'VmwDatastore', 
               'VmwDatastoreCluster', 'VmwVSS', 'VmwVSSPortgroup', 'VmwVDS', 
               'VmwVDSPortgroup'
